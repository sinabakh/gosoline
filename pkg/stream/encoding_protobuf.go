...
func (e protobufEncoder) Encode(data interface{}, _ map[string]string) ([]byte, error) {
...
func (e protobufEncoder) Decode(data64 []byte, _ map[string]string, out interface{}) error {

...
func TestTransport(t *testing.T) {
	writer, err := producer.NewWriter(
		logMocks.NewLoggerMock(logMocks.WithMockAll, logMocks.WithTestingT(t)), writerDialer, writerConf,
...
func TestSaneDefaults(t *testing.T) {
	writer, err := producer.NewWriter(logMocks.NewLoggerMock(logMocks.WithMockAll, logMocks.WithTestingT(t)), writerDialer, writerConf)
	assert.Nil(t, err)
